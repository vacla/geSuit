...
public class BSVersionCommand extends Command {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        //Send out the BungeeSuitePlus version
        sender.sendMessage(ChatColor.RED + "BungeeSuitePlus version - " + ChatColor.GOLD + BungeeSuite.instance.getDescription().getVersion());
