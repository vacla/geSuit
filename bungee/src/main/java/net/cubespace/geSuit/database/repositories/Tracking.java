...
public class Tracking extends BaseRepository {
    ...
    private Track readTracking(ResultSet results) throws SQLException {
        return new Track(
                ...
                results.getBoolean("name_ban"), 
                results.getBoolean("ip_ban")
        );
    }
