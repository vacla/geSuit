...
/**
 * Channels provide a cross-server reliable communication system.
 * Each channel can be typed allowing neat code useage.
 *
 * @param <T> T is the type of data used in this channel. By default, this is {@code byte[]} but can be anything as long as you set a codec with {@link Channel#setCodec(ChannelCodec)}
 */
