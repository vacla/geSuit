package net.cubespace.geSuit.teleports.misc;
...
public class LocationUtil {
    ...
    public static final Set<Material> HOLLOW_MATERIALS = Sets.newHashSet();
    ...
    static {
        ...
        HOLLOW_MATERIALS.add(Material.BANNER);
    ...
    public static Location toBukkit(net.cubespace.geSuit.core.objects.Location location, World defWorld) {
        World world = defWorld;
    ...
    public static net.cubespace.geSuit.core.objects.Location fromBukkit(Location location) {
        return fromBukkit(location, null);
    }
    
    public static net.cubespace.geSuit.core.objects.Location fromBukkit(Location location, String server) {
        return new net.cubespace.geSuit.core.objects.Location(server, location.getWorld().getName(), location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch());
    }
}
